...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/rocky_monitor/rocky_monitor.db
      """
  ...
  config :rocky_monitor, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :rocky_monitor, RockyMonitor.Mailer,
